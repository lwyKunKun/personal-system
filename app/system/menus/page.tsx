...
export default function MenusManagerPage() {
  ...
  const addChildItem = (path: number[]) => {
    ...
    setItems((prev) => {
      ...
      const newChild: SidebarMenuItem = { label, icon: newIcon.trim() || undefined, iconName: newIconName.trim() || undefined, visible: newVisible, sortOrder: childCount }
                    ...
                    <div className="rounded-xl border border-white/8 bg-[#0b1220] p-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="text-xs text-slate-400 leading-relaxed">
                          ...
                          <p>
                            请前往{" "}
                            <Link href="/system/permissions" className="text-[#ffb476] hover:underline">
                              系统管理 → 权限管理
                            </Link>{" "}
                            配置角色的菜单访问权限。
                          </p>
